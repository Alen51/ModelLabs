...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.BASICISCEDULE_V1M, typeof(UnitMultiplier));														
			property2enumType.Add(ModelCode.BASICISCEDULE_V2M, typeof(UnitMultiplier));														
			property2enumType.Add(ModelCode.BASICISCEDULE_V1U, typeof(UnitSymbol));														
			property2enumType.Add(ModelCode.BASICISCEDULE_V2U, typeof(UnitSymbol));														
