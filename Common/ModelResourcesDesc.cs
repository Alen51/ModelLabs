...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			typeIdsInInsertOrder.Add(ModelCode.REGULARISCHEDULE);
			typeIdsInInsertOrder.Add(ModelCode.REGULARTPOINT);
			typeIdsInInsertOrder.Add(ModelCode.SWITCHINGOPERATION);
			typeIdsInInsertOrder.Add(ModelCode.DISCONECTOR);
            typeIdsInInsertOrder.Add(ModelCode.IRREGULARTPOINT);
		...
		{			
            ...
            notSettablePropertyIds.Add(ModelCode.IRREGULARISCHEDULE_ITIMEPOINTS);
            notSettablePropertyIds.Add(ModelCode.REGULARISCHEDULE_RTPOINTS);
		}
